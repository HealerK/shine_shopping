...
if(isset($_POST['submit'])) {
    if (empty($_POST['name']) || empty($_POST['description'])) {
        ...
        $sql = $pdo->prepare("INSERT INTO categories(name,description) VALUES (:name,:description)");
        ...
        if($result) {
            echo "<script>alert('Create Successfully.');window.location.href='category.php';</script>";
        }
    }
}
