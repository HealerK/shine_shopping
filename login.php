...
if (isset($_POST['submit'])) {
	if (empty($_POST['email']) || empty($_POST['password'])) {
		...
		echo "<script>alert('Incorrect Indential');</script>";
	}
}
					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="login.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group mb-5">
								<input style="<?php echo empty($passwordError) ? '' : 'border:1px solid red' ?>" type="password" class="form-control" id="name" name="password" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" class="primary-btn" name="submit">Log In</button>
							</div>
						</form>
					</div>
				</div>
